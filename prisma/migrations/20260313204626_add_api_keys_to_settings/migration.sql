...
INSERT INTO "new_Settings" ("broadcasterId", "createdAt", "id", "notificationsEnabled", "refreshInterval", "twitchUsername", "updatedAt") SELECT "broadcasterId", "createdAt", "id", "notificationsEnabled", "refreshInterval", "twitchUsername", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
